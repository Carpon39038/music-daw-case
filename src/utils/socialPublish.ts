...
export function createSocialCardBlob(project: ProjectState, totalDurationSec: number): Promise<Blob> {
  const width = 1200
  const height = 630
  ...
  ctx.fillText(project.name || 'Untitled Project', 72, 140)

  ctx.fillStyle = '#a7f3d0'
  ctx.font = '500 30px sans-serif'
  ctx.fillText('Music DAW Case • Social Audio Card', 72, 188)
  ...
  ctx.fillText('Generated by Music DAW Case', 72, 570)
