...
// Insert it right after the closing div of "track-reverb-controls" block?
// No, let's insert it before <div className="track-reverb-controls"
const searchStr = '<div className="track-reverb-controls"';
if (code.includes(searchStr)) {
  code = code.replace(searchStr, uiLogic + '\n' + searchStr);
